...
const TString sPlotsStore = "plotsXSZ4l/";
...
/*
    TString obsTag = "pT4l";
    const TString sTemplateDirName = "templatesXSZ4l/DTreeXS_"+obsTag+"/8TeV/";
    const int N_BINS = 4;
...
//                for (int k = 0; k < nSmooth; k++) smoothAndNormaliseTemplate1D(h1D_4e[iBkg][iBin]);
    ...
    // prepare dummy
    double var_plotHigh = 110, var_plotLow = 50;
    int var_nBins = 20;
